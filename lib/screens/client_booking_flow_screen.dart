...
class _ClientBookingFlowScreenState extends State<ClientBookingFlowScreen> {
                  ...
                  Expanded(
                    child: FilledButton(
                      ...
                      child: _submitting
                          ...
                          : Text(
                              _step < 3 ? 'Continue' : 'Confirm booking',
    ...
    return Column(
      ...
      children: [
        ...
        if (_sessionType == 'physical') ...[
          const SizedBox(height: 10),
          _sectionTitle('Physical visit location'),
          const SizedBox(height: 8),
          TextField(
            ...
            maxLines: 4,
            decoration: InputDecoration(
              hintText: 'Street, ward, city, landmarks (required)',
              filled: true,
              fillColor: SmartAfyaPalette.softBlue,
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide.none),
            ),
        ...
        children: [
          ...
          Text(
            _sessionType == 'physical'
                ...
                : 'You’ll pay ${_priceLabel()} via Mobile Money (Lipa Namba) or Bank after confirmation.',
            style: const TextStyle(color: SmartAfyaPalette.mutedText, height: 1.35),
          ),
          const SizedBox(height: 10),
          Wrap(
  ...
  Future<void> _submit() async {
    ...
    if (_sessionType == 'physical') {
      if (_physicalAddressController.text.trim().length < 5) {
        setState(() => _error = 'Please enter a clear physical address/location.');
        return;
      }
    ...
    try {
      final preferredIso = _selectedSlots
      ...
      await _api.createBooking(
        ...
        physicalNotes: _sessionType == 'physical' ? _physicalNotesController.text.trim() : null,
      );
      ...
      if (_sessionType == 'physical') {
        ...
        await NotificationService.showPaymentRequest(
          ...
          body: 'We’ll confirm your session and send a payment request shortly.',
        );
      }
